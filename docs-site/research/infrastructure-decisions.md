...
This document captures the _evaluation process_ — why we chose each infrastructure tool. The [Infrastructure](/engineering/architecture/infrastructure) page in Engineering has the technical spec and implementation details. This page has the research, options considered, and decision rationale.
