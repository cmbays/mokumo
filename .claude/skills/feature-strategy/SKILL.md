...
6. `src/domain/entities/` — Data model. Know what entities exist.
...
- **Data model check**: Confirm proposed features can be supported by existing schemas in `src/domain/entities/`
