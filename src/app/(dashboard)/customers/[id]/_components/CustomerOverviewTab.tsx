  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1 min-w-0">
        ...
        <ActivityTimeline quotes={quotes} jobs={jobs} notes={notes} onSwitchTab={onSwitchTab} />
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {artworks.slice(0, 4).map((artwork) => (
                <div
                  key={artwork.id}
                  className="rounded-md border border-border overflow-hidden bg-elevated shadow-[1.5px_1.5px_0_rgba(255,255,255,0.04)]"
                >
