 ...
 * Exported so customers.ts can use it in getContacts / getById.
 */
...
/**
 * Map a DB contacts row to the ContactRow port type.
 * Uses contactRowSchema.parse() for runtime validation — consistent with mapCustomerRow / mapAddressRow.
 */
function mapContactDbRow(row: typeof contactsTable.$inferSelect): ContactRow {
...
export const supabaseContactMethods = {
