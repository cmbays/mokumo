/**
 * Pure utilities for the products sync pipeline.
 * Extracted for testability — no side effects, no server imports.
 */
import { z } from 'zod'
...
// ---------------------------------------------------------------------------
// S&S product schema — mirrors /v2/products/ response shape
// ---------------------------------------------------------------------------
