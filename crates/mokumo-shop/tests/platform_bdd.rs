...
#[path = "platform_bdd_world/mod.rs"]
mod platform_bdd_world;
...
#[tokio::main]
async fn main() {
    platform_bdd_world::PlatformBddWorld::cucumber()
        ...
        .filter_run_and_exit("tests/platform_features", |feature, _, sc| {
